...
function Cart({ basketProps, productQuantity, clearProduct }) {
  ...
  // const productImages = [ReaperEmote, LoveEmote, RageEmote, HypeEmote];
  const productImages = (product) => {
    if (product.tagName === 'ReaperEmote') {
      ...
      return HypeEmote;
    } else if (product.tagName === 'AcesBadge') {
      return AcesBadge;
    } else if (product.tagName === 'HighRollerBadge') {
      return HighRollerBadge;
    } else if (product.tagName === 'MoneyBadge') {
      return MoneyBadge;
    }
  };
